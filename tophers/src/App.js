...
const images = importAll(require.context('/Users/corey/Desktop/TophersManDr/workpics', false, /\.(png|jpe?g|svg)$/));
...
const App = () => {
        ...
        <div className="half-width black-background">
          ...
          <a href="#section5">
            <button className="contact-button">Contact Me</button>
              ...
              <h1 className="centered-title">About Topher's Maintenance and Repair</h1>
  ...
  <img key={index} src={image.default} className="slide" alt={`Work ${index + 1}`} />
))}
  </div>
</section>
